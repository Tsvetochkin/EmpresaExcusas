...
public class DeliveryModo {
    ...
    private IModo buscarModo(Class<? extends IModo> clase) {
        return modos.stream()
                ...
                .findFirst()
                .orElse(modos.get(1)); // По умолчанию Normal
    }
